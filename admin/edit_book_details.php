...
<html lang="en">
    ...
    <head>
        ...
        <title>PSAU THESIS LIBRARY MANAGEMENT SYSTEM</title>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">PSAU THESIS LIBRARY MANAGEMENT SYSTEM </a>
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Thesis Title:</label></b>
                                            <div class="controls">
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; PSAU THESIS LIBRARY MANAGEMENT SYSTEM </b>
            </div>
        </div>
