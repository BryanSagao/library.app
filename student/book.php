            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">THESIS LIBRARY MANAGEMENT SYSTEM </a>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; THESIS LIBRARY MANAGEMENT SYSTEM</b>
            </div>
        </div>
